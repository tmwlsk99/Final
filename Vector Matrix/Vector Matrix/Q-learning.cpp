...
int main()
{
	...
	for (int t = 0; t < 1000; t++)
	{
		...
		if (world.isInside(i, j) == true) // move robot if available
		{
			...
			world.getCell(1, 1).q_[3] = world.getCell(2, 1).reward_;
			world.getCell(1, 0).q_[3] = world.getCell(2, 0).reward_;
			...
			world.getCell(0, 1).q_[3] = MAX4(world.getCell(1, 1).q_[0], world.getCell(1, 1).q_[1], world.getCell(1, 1).q_[2], world.getCell(1, 1).q_[3]) + world.getCell(0, 1).reward_;
			world.getCell(0, 0).q_[0] = MAX4(world.getCell(0, 1).q_[0], world.getCell(0, 1).q_[1], world.getCell(0, 1).q_[2], world.getCell(0, 1).q_[3]) + world.getCell(0, 0).reward_;
			world.getCell(1, 0).q_[0] = MAX4(world.getCell(1, 1).q_[0], world.getCell(1, 1).q_[1], world.getCell(1, 1).q_[2], world.getCell(1, 1).q_[3]) + world.getCell(1, 0).reward_;
			world.getCell(0, 0).q_[3] = MAX4(world.getCell(1, 0).q_[0], world.getCell(1, 0).q_[1], world.getCell(1, 0).q_[2], world.getCell(1, 0).q_[3]) + world.getCell(0, 0).reward_;

			world.getCell(0, 1).q_[1] = MAX4(world.getCell(0, 0).q_[0], world.getCell(0, 0).q_[1], world.getCell(0, 0).q_[2], world.getCell(0, 0).q_[3]) + world.getCell(0, 1).reward_;
			world.getCell(1, 1).q_[1] = MAX4(world.getCell(1, 0).q_[0], world.getCell(1, 0).q_[1], world.getCell(1, 0).q_[2], world.getCell(1, 0).q_[3]) + world.getCell(1, 1).reward_;
			world.getCell(1, 0).q_[2] = MAX4(world.getCell(0, 0).q_[0], world.getCell(0, 0).q_[1], world.getCell(0, 0).q_[2], world.getCell(0, 0).q_[3]) + world.getCell(1, 0).reward_;
			world.getCell(1, 1).q_[2] = MAX4(world.getCell(0, 1).q_[0], world.getCell(0, 1).q_[1], world.getCell(0, 1).q_[2], world.getCell(0, 1).q_[3]) + world.getCell(1, 1).reward_;
